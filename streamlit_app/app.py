...
Main entry point. Sets up page config, navigation, and initializes DB.
"""
...
from services.auth_service import (
    is_logged_in, get_or_create_user, render_user_sidebar, claim_legacy_data,
)
...
if not is_logged_in():
    ...
    # Google Sign-in button styling — keep blue background, add Google logo
    st.markdown("""
    <style>
    ...
    if user:
        ...
        # Check for legacy data (portfolios with NULL user_id)
